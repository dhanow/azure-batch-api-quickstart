...
namespace AzureBatchQuickstart
{
    public class Program
    {
        ...
        private const string BatchAccountName = "sridharbatch";
        private const string BatchAccountKey = "lBI47lSn8s4OZDTKtYPs0Zqf7SuOuwvc2re768z64LIsqCtbnisJn+Zz4v8eggHGmDHlWJbC4DbdebPVIaRL3g==";
        private const string BatchAccountUrl = "https://sridharbatch.southcentralus.batch.azure.com";

        // Storage account credentials
        private const string StorageAccountName = "sridharbatchstorage";
        private const string StorageAccountKey = "K1O4lgB+iY69wwwwRkYMAYa1dQ0aJ8Wrk6YbHuE/6s5Vvxdh4LCWA6uwlInT66HjyqEiN39Xv7Qz3ezzsKN4Sw==";
